(function (global, factory) {
    ...
    (global = global || self, factory(global['@hpcc-js/common'] = {}, global['@hpcc-js/util']));
    ...
    ***************************************************************************** */
    ...
    var Class = /** @class */ (function () {
        ...
        Class.prototype.classMeta = function () {
            return util.classID2Meta(this.classID());
        };
            ...
            this.publishedProperties(false).filter(function (meta) { return ignore.indexOf(meta.id) < 0; }).forEach(function (meta) {
                if (_this[meta.id + "_exists"]()) {
                    ...
                    switch (proxyMeta.type) {
                        ...
                        case "widgetArray":
                        case "propertyArray":
                            value = util.hashSum(value.map(function (v) { return v.hashSum(); }));
                            break;
                        default:
                    }
                    props[meta.id] = value;
    ...
    function timestamp() {
        ...
        var timeFormat = exports.timeFormat("%Y-%m-%dT%H_%M_%S");
    ...
    var Field = /** @class */ (function (_super) {
        ...
        Field.prototype.formatter = function (format) {
            ...
            switch (this.type()) {
                case "time":
                case "date":
                    return exports.timeFormat(format);
            }
            retVal = exports.format(format);
            retVal.parse = function (_) {
                return _;
            };
            return retVal;
    ...
    function formatPicker(formats, cell) {
        for (var i = 0; i < formats.length; ++i) {
            var date = exports.timeParse(formats[i])(cell);
            if (date) {
    ...
    function d3Drag() {
      ...
      function mousedowned() {
        ...
        if (!gesture) return;
        d3Select(exports.event.view).on("mousemove.drag", mousemoved, true).on("mouseup.drag", mouseupped, true);
      ...
      function mouseupped() {
        d3Select(exports.event.view).on("mousemove.drag mouseup.drag", null);
        ...
        function ResizeSurface() {
            ...
            _this.drag
                ...
                if (context.allowResize()) {
                    exports.event.sourceEvent.stopPropagation();
                ...
                if (context.allowResize()) {
                    exports.event.sourceEvent.stopPropagation();
                    var _dx = exports.event.x - context._dragHandlePos.x;
                    var _dy = exports.event.y - context._dragHandlePos.y;
    ...
    function brush(dim) {
      ...
      function started() {
        ...
        if (exports.event.touches) {
          ...
          var view = d3Select(exports.event.view)
    ...
    function d3Zoom() {
      ...
      function mousedowned() {
        if (touchending || !filter.apply(this, arguments)) return;
        var g = gesture(this, arguments),
            v = d3Select(exports.event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true),
            p = mouse(this),
    ...
    var SVGZoomWidget = /** @class */ (function (_super) {
        ...
        SVGZoomWidget.prototype.onZoomed = function () {
            if (exports.event && exports.event.transform && this._mouseDownMode === "zoom") {
                this._zoomScale = exports.event.transform.k;
                this._zoomTranslate = [exports.event.transform.x, exports.event.transform.y];
                this._zoomG.attr("transform", exports.event.transform);
            }
        };
        SVGZoomWidget.prototype.enter = function (domNode, element) {
            ...
            d3Select(window)
                .on("keydown", function () {
                if (_this._mouseCapture && exports.event.ctrlKey) ;
            })
                .on("keyup", function () {
    ...
    exports.EntityPin = EntityPin;
    exports.EntityRect = EntityRect;
    exports.EntityRectList = EntityRectList;
    exports.EntityVertex = EntityVertex;
    ...
    exports.SVGGlowFilter = SVGGlowFilter;
    ...
    exports.interpolateViridis = d3InterpolateViridis;
    ...
    exports.scan = scan;
    exports.schemeCategory10 = d3SchemeCategory10;
    exports.schemeCategory20 = d3SchemeCategory20;
    exports.schemeCategory20b = d3SchemeCategory20b;
    exports.schemeCategory20c = d3SchemeCategory20c;
    ...
    exports.values = d3Values;
    exports.variance = d3Variance;
