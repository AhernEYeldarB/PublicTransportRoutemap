import { HTMLWidget, FAChar, Platform, Utility, Database, Palette, SVGWidget, IconBar, Spacer, ProgressBar, ToggleButton, Text, Button, TitleBar } from '@hpcc-js/common';
...
var Border = /** @class */ (function (_super) {
    ...
    function Border() {
        var _this = _super.call(this) || this;
        _this.lazyPostUpdate = Utility.debounce(function () {
            this.postUpdate();
        }, 100);
        _this._tag = "div";
        _this._colCount = 0;
...
var Legend = /** @class */ (function (_super) {
    ...
    Legend.prototype.fillColorFunc = function () {
        ...
        var palette = Palette.ordinal(widget && widget.paletteID ? widget.paletteID() || "default" : "default");
        return function (row, col, sel) {
            return palette(col);
        };
    };
...
var ChartPanel = /** @class */ (function (_super) {
    ...
    function ChartPanel() {
        ...
        _this._toggleInfo = new ToggleButton().faChar("fa-info-circle").tooltip(".Description")
            .selected(false)
            .on("enabled", function () {
            ...
            if (_this._toggleInfo.selected()) {
                _this._modal
                    .title(_this.title())
                    .widget(new Text().text(_this.description()))
                    .show(true)
                    .render();
        ...
        _this._toggleData = new ToggleButton().faChar("fa-table").tooltip("Data")
            .on("click", function () {
            _this.dataVisible(_this._toggleData.selected());
            _this.render();
        });
        _this._buttonDownload = new Button().faChar("fa-download").tooltip("Download")
            .on("click", function () {
            _this.downloadCSV();
        });
        _this._buttonDownloadImage = new Button().faChar("fa-image").tooltip("Download Image")
            .on("click", function () {
            _this.downloadPNG();
        });
        _this._toggleLegend = new ToggleButton().faChar("fa-list-ul").tooltip("Legend")
            .selected(false)
            .on("click", function () {
            _this.legendVisible(_this._toggleLegend.selected());
            _this.render();
        });
        _this._spacer = new Spacer();
        _this._titleBar = new TitleBar().buttons([_this._toggleData, _this._buttonDownload, _this._buttonDownloadImage, _this._spacer, _this._toggleLegend]);
        _this._carousel = new Carousel();
        _this._table = new Table();
    ...
    ChartPanel.prototype.downloadCSV = function () {
        ...
        var nameSuffix = this.downloadTimestampSuffix() ? "_" + Utility.timestamp() : "";
