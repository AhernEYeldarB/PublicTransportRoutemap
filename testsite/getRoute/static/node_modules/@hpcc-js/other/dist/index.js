(function (global, factory) {
    ...
    */
    ...
    CalendarHeatMap.prototype.mixin(common.Utility.SimpleSelectionMixin);
    CalendarHeatMap.prototype._palette = common.Palette.rainbow("default");
    ...
    ESPMappings.prototype.contains = function (resultName, origField) {
        return common.Utility.exists(resultName + "." + origField, this._mappings);
    };
    ...
    var WsWorkunits = /** @class */ (function (_super) {
        ...
        WsWorkunits.prototype.WUQuery = function (_request, callback) {
            ...
            return this.jsonp(url, request).then(function (response) {
                if (!common.Utility.exists("WUQueryResponse.Workunits.ECLWorkunit", response)) {
    ...
    var HeatMap = /** @class */ (function (_super) {
        ...
        HeatMap.prototype.resize = function (size) {
            var retVal = common.CanvasWidget.prototype.resize.apply(this, arguments);
    ...
    HeatMap.prototype._palette = common.Palette.rainbow("default");
    ...
    var IconList = /** @class */ (function (_super) {
        ...
        function IconList() {
            ...
            _this._entity_list = [];
            _this._content_list = [];
            _this._list = new layout.HorizontalList()
        ...
        IconList.prototype.update = function (domNode, element) {
            ...
            this.data().forEach(function (row, idx) {
                if (!listWidgets[idx]) {
                    listWidgets[idx] = _this.updateListProperties(new layout.VerticalList(), idx)
                        .widgets([
                        _this.updateEntityProperties(new common.Entity(), idx),
    ...
    var Table = /** @class */ (function (_super) {
        ...
        Table.prototype.update = function (domNode, element) {
            ...
            if (this.sortByFieldIndex_exists() && (this._prevSortByFieldIndex !== this.sortByFieldIndex() || this._prevDescending !== this.descending())) {
                common.Utility.multiSort(data, [{ idx: this.sortByFieldIndex(), reverse: this.descending() }]);
            ...
            cellsSel.enter()
                ...
                var el = d3Select(this);
                if (tdContents.cell instanceof common.Widget) {
            ...
            setTimeout(function () {
                context._paginator
                    .right((context.hasVScroll(element) ? common.Platform.getScrollbarWidth() : 0) + context._paginatorTableSpacing)
                    .bottom((context.hasHScroll(element) ? common.Platform.getScrollbarWidth() : 0) + context._paginatorTableSpacing)
                    .render(function () {
        ...
        Table.prototype._calcRowsPerPage = function (th) {
            ...
            var ipp = Math.floor((this.height() - thHeight - tfootHeight - paginatorHeight - (this.table.style("width") >= this.table.style("width") ? common.Platform.getScrollbarWidth() : 0) - this._paginatorTableSpacing * 2) / tcellHeight) || 1;
            if (this.totalledColumns().length !== 0) {
                ipp -= 1;
            }
            return ipp;
    ...
    Legend.prototype.getBBox = function (refresh, round) {
        ...
        if (!table.empty()) {
            var tableRect = table.node().getBoundingClientRect();
            var width = tableRect.width + 8 + (this.hasVScroll(this._placeholderElement) ? common.Platform.getScrollbarWidth() : 0);
            var height = tableRect.height + 8 + (this.hasHScroll(this._placeholderElement) ? common.Platform.getScrollbarWidth() : 0);
            return {
                x: retVal.x,
                y: retVal.y,
            ...
            switch (param.type) {
                ...
                default:
                    if (param.ext && param.ext.range) {
                        ...
                        if (param.type === "html-color" && !common.Platform.isIE) {
                            cell.append("input")
    ...
    exports.Comms = Comms$1;
    exports.HPCCBadge = HPCCBadge;
    exports.HeatMap = HeatMap;
    exports.Html = Html;
    exports.IconList = IconList;
    exports.Legend = Legend;
    exports.MorphText = MorphText;
    exports.MouseHoverColumn = MouseHoverColumn;
    exports.NestedTable = NestedTable;
