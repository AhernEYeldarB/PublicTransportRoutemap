...
from multigtfs.models import (Agency, Block, Fare, FareRule, Feed, FeedInfo,
...
urlpatterns = [
    ...
    url(r'feed/(?P<feed_id>\d+)/agency/(?P<pk>\d+)/$',
        DetailView.as_view(model=Agency),
        name='agency_detail'),
